# Generated by Django 3.2.2 on 2021-07-30 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='quiz.cateogry')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.IntegerField(choices=[(0, 'Fundamental'), (1, 'Beginner'), (2, 'Intermediate'), (3, 'Advanced'), (5, 'Expert')], default=0, verbose_name='Difficulty')),
